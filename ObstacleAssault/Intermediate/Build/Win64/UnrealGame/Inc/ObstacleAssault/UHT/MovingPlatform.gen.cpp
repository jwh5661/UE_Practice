...
struct Z_CompiledInDeferFile_FID_UnrealProjects_UE_Practice_ObstacleAssault_Source_ObstacleAssault_MovingPlatform_h__Script_ObstacleAssault_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AMovingPlatform, AMovingPlatform::StaticClass, TEXT("AMovingPlatform"), &Z_Registration_Info_UClass_AMovingPlatform, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMovingPlatform), 3539611546U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_UE_Practice_ObstacleAssault_Source_ObstacleAssault_MovingPlatform_h__Script_ObstacleAssault_2535893439(TEXT("/Script/ObstacleAssault"),
